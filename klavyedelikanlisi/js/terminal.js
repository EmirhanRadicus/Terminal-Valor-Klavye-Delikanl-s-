/* ============================================
   TERMINAL APP — Hacker terminal emulator
   with VS Code-style autocomplete
   ============================================ */
const TerminalApp = (function () {
  ...
  // Command definitions for autocomplete (game-state-aware)
  ...
  function bindEvents($window) {
    ...
    $(document).on('click', '.term-ac-item', function () {
  ...
  function cmdScan(args) {
    ...
    const scanSteps = [
      ...
      { text: '[+] İşletim Sistemi: Linux Ubuntu 20.04', delay: 400 },
      { text: '[+] Web Sunucu: nginx/1.18.0', delay: 300 },
      { text: '[+] CMS: WordPress 5.8.1 (güncel değil!)', delay: 300 },
      { text: '[+] Veritabanı: MySQL 8.0', delay: 300 },
      { text: '[!] Potansiyel zafiyetler tespit edildi:', delay: 500 },
      { text: '    • SQLi: /login.php (form parametreleri)', delay: 200 },
      { text: '    • XSS: /search?q= (reflected)', delay: 200 },
      { text: '    • CVE-2021-44228: Log4j (kritik)', delay: 200 },
      { text: '    • Directory Listing: /backup/ açık', delay: 200 },
      { text: '', delay: 100 },
      { text: '[✓] Tarama tamamlandı. 15 dakika geçti.', delay: 0, cls: 'cmd-success' },
    ];
    let totalDelay = 600;
